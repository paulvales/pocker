...
instructions: Use this rule when the task is complex, multi-step, risky, or affects multiple files, shared contracts, architecture, or migrations.
---

---
description: Guide the agent to work in small, safe, reviewable steps
