...
export function normalizeEstimationMode(mode) {
...
export function normalizePublicRoom(value) {
  const payload = asRecord(value);
...
export function createRoomSnapshotPayload(value = {}) {
  const payload = asRecord(value);
...
export function parseCreateRoomPayload(value) {
  const payload = asRecord(value);
...
export function parseNoteUpdatePayload(value) {
  const payload = asRecord(value);
...
export function parseJoinPayload(value) {
  const payload = asRecord(value);
...
export function parseTaskListUpdatePayload(value) {
  const payload = asRecord(value);
...
export function parseSetEstimationModePayload(value) {
  const payload = asRecord(value);
...
export function parseTaskSelectPayload(value) {
  const payload = asRecord(value);
...
export function parseVotePayload(value) {
  const payload = asRecord(value);
...
export function parseSetReactionPayload(value) {
  const payload = asRecord(value);
...
export function parseSetStoryPointsPayload(value) {
  const payload = asRecord(value);
...
export function parseRoomIdPayload(value) {
...
export function parseHistoryFilters(source) {
  return {
...
export function createHistoryResponse({ items = [], meta = {} } = {}) {
...
export function createSaasBootstrapPayload(value = {}) {
  const payload = asRecord(value);
...
export function createHealthPayload({ version, build } = {}) {
  return {
    status: 'ok',
...
export function createVersionPayload({ version, build, label } = {}) {
  return {
    version: normalizeLooseText(version),
    build: normalizeNullableText(build),
...
export function createSocketAckSuccess(payload = {}) {
  return {
    ok: true,
    ...asRecord(payload),
  };
...
export function getErrorCode(error, fallback = ERROR_CODES.unknown) {
  const message = normalizeText(error?.message);
  return message || fallback;
}

export function createSocketAckError(error, fallback = ERROR_CODES.unknown) {
  return {
    ok: false,
